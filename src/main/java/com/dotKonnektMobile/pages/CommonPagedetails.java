...
public class CommonPagedetails extends BaseClass {
	...
	String searchClickButton=  "//button[@id='sg-autoCompleteSearchBarSubmitBtn']";
	...
	String searchIconbutton = "//img[@id='sg-searchHeaderImg']";
	public boolean validateSearchBox() {
		boolean result  = getDriver().findElement(By.xpath(searchIconbutton)).isDisplayed();
		return result;
	}
	...
	String menuButton = "(//*[name()='svg'][@id='sg-mobileHeaderMenuIcon'])";
	public boolean validateMenuButton() {
		boolean result  = getDriver().findElement(By.xpath(menuButton)).isDisplayed();
		return result;
	}
	...
	public void validateSeachFunctionality(String searchData, String ClickedBy,String Title) throws InterruptedException {
		getDriver().findElement(By.xpath(searchIconbutton)).click();
		...
		getDriver().findElement(By.xpath(searchClickButton)).click();	
		}
