...
public class ProductPage extends BaseClass {
	...
	public void productDetailVerification() throws InterruptedException {
		...
		if(ProductImages.getAttribute("srcset").contains("shopify.com")) {
		...
		if (value1.equals(value2)) {
			...
			System.out.println("Product image is not present");
			Assert.assertTrue(false, "Product image is not present");
		}
	...
	String carticon = "(//button[@id='sg-productCardQuickViewText'])";
	...
	String recentQuestions = "(//div[@id='sg-productDetailRecentQuestions'])";
	//String viewAll= "(//div[@class='MuiBox-root css-1hm6ahe'])/a";
	String Questions = "(//div[@id='sg-accordionWrapper'])";
	String  totalQue = "(//div[@id='sg-accordionWrapper'])/div[1]";
	String queText = "//div[@id='sg-accordionHeader']";
	String plusIcon = "//*[name()='svg' and @data-testid='AddIcon']";
	String removeIcon = "//*[name()='svg' and @data-testid='RemoveIcon']";
	String ansText = "(//div[@id='sg-accordionDetails'])";
	public void faqSections() throws InterruptedException {
		
		WebElement bodyTag = getDriver().findElement(By.tagName("body"));
		//Thread.sleep(1000);
		//System.out.println(bodyTag.getText());
		if(bodyTag.getText().contains("Recent Questions")) {
